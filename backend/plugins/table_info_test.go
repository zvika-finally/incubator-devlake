...
func Test_GetPluginTablesInfo(t *testing.T) {
	...
	checker.FeedIn("aidetector/models", aidetector.AIDetector{}.GetTablesInfo)
	...
	checker.FeedIn("businessmetrics/models", businessmetrics.BusinessMetrics{}.GetTablesInfo)
	...
	checker.FeedIn("findevops/models", findevops.FinDevOps{}.GetTablesInfo)
